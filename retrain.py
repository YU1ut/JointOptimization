...
#Method options
parser.add_argument('--out', default='retrain_result',
...
def main():
    ...
    trainset = dataset.CIFAR10_train('./data', args=args, train=True, transform=transform_train)
    trainset.reload_label()
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        test_loss, test_acc = testidate(testloader, model, test_criterion, epoch, use_cuda)
...
def train(trainloader, model, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets, soft_targets, indexs) in enumerate(trainloader):
        ...
        loss = mycriterion(outputs, soft_targets)
...
def testidate(testloader, model, criterion, epoch, use_cuda):
    global best_acc
...
def adjust_learning_rate(optimizer, epoch):
    global state
    if epoch in [int(args.epochs / 3), int(args.epochs * 2 / 3)]:
        state['lr'] *= 0.1
